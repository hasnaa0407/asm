...
appuyesS db "tappez S pour sortir a la fin de cette manche R pour une nouvelle partie$"
...
main proc
  ...
  do_while_tour_de_1:
    ...
    ;hna jnsp kifah hadi tae printinstruction!!!! 
  ...
  jne do_while 
    ...
    je travailler_directement_sont_random
    ...
    jmp skip_travailler_directement_sont_random
     
    travailler_directement_sont_random:    
    ...
    skip_travailler_directement_sont_random:
...
affichageavance proc 
   ...
   int 10h
    ...
    mov dl,[si]
    cmp dl,1
    jne pionblanc_damenoire_dameblanche_videe
    mov dl,charpion
    mov dh,colornoir
    call print
    jmp fine
    pionblanc_damenoire_dameblanche_videe:
    cmp dl,2
    jne damenoire_dameblanche_videe
    mov dl,charpion
    mov dh,colorblanc
    call print
    jmp fine
    damenoire_dameblanche_videe: 
    cmp dl,3
    jne dameblanche_videe 
     mov dl,chardame
    mov dh,colornoir
    call print     
    jmp fine
    ...
    jne pionblanc_damenoire_dameblanche_videe2
    ...
    pionblanc_damenoire_dameblanche_videe2: 
    
    cmp dl,2
    
    jne damenoire_dameblanche_videe2 
    mov dl,charpion
    mov dh,colorblanc
    call print
    ...
    damenoire_dameblanche_videe2: 
    
    cmp dl,3
    
    jne dameblanche_videe2 
    mov dl,chardame
    mov dh,colornoir
    call print
    ...
    fine2:  
    inc si 
    loop boucle_affichagee_3
    suitee:
    mov ah, 09h       
    lea dx,saut
    int 21h
    pop cx
    loop boucle_affichagee_1
    pop bp
    popa
    ret    
    
affichageavance endp                   
